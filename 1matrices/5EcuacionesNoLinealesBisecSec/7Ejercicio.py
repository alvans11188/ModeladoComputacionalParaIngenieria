...
sec = secant_iterations(f,0.0,1.0)
print("Biseccion (primeras 6 iteraciones / última):")
...
print("\nResultado final:")
print("Bisección raiz =", bis[-1][3], "iter =", bis[-1][0])
print("Secante raiz =", sec[-1][2], "iter =", sec[-1][0])